...
* **Usage:**
  ```bash
  npx --yes --package=github:elmissouri16/search-console-mcp#v1.14.2-security.2 search-console-mcp login
  ```
...
* **Usage:**
  ...
  npx --yes --package=github:elmissouri16/search-console-mcp#v1.14.2-security.2 search-console-mcp accounts remove --account=user@company.com
  ```
...
* **Usage:**
  ```bash
  npx --yes --package=github:elmissouri16/search-console-mcp#v1.14.2-security.2 search-console-mcp sites
  ```
...
* **Usage:**
  ```bash
  npx --yes --package=github:elmissouri16/search-console-mcp#v1.14.2-security.2 search-console-mcp diagnostics
  ```
...
* **Usage:**
  ```bash
  npx --yes --package=github:elmissouri16/search-console-mcp#v1.14.2-security.2 search-console-mcp update
  ```
...
### Syntax
```bash
npx --yes --package=github:elmissouri16/search-console-mcp#v1.14.2-security.2 search-console-mcp run <tool_name> [options] [--format=json|csv|table]
```
...
```bash
# Print as CSV
npx --yes --package=github:elmissouri16/search-console-mcp#v1.14.2-security.2 search-console-mcp run sites_list --engine=google --format=csv

# Print as a clean ASCII table
npx --yes --package=github:elmissouri16/search-console-mcp#v1.14.2-security.2 search-console-mcp run seo_striking_distance --siteUrl=https://example.com --format=table
```
...
npx --yes --package=github:elmissouri16/search-console-mcp#v1.14.2-security.2 search-console-mcp run analytics_query --help
```
