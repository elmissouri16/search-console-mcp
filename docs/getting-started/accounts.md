...
```bash
npx --yes --package=github:elmissouri16/search-console-mcp#v1.14.2-security.2 search-console-mcp accounts remove --account=marketing@company.com
```
...
```bash
npx --yes --package=github:elmissouri16/search-console-mcp#v1.14.2-security.2 search-console-mcp accounts add-site --account=marketing@company.com --site=example.com
```
...
```bash
npx --yes --package=github:elmissouri16/search-console-mcp#v1.14.2-security.2 search-console-mcp accounts remove --site=example.com
```
